...
The next step on the [last week of Bootcamp]({{ site.baseurl }}{% link _posts/bootcamp3.md %}) will be to conduct a more in depth user research and testing, looking into user journeys and iterate the UI based on feedback/results. Then finalise the design before deployment.